...
class TetrahedraSDFGrid(BaseExplicitGeometry):
    ...
    class Config(BaseExplicitGeometry.Config):
        ...
        isosurface_outlier_n_faces_threshold: Union[int, float] = 0.5
        ...
        shape_init: Optional[str] = "sphere"
        shape_init_params: Optional[Any] = 0.5
    ...
    def initialize_shape(self) -> None:
        ...
        if self.cfg.shape_init == "ellipsoid":
            ...
            get_gt_sdf = func
        elif self.cfg.shape_init == "randn":
            assert isinstance(self.cfg.shape_init_params, float)
            std_val = self.cfg.shape_init_params

            def func(points_rand: Float[Tensor, "N 3"]) -> Float[Tensor, "N 1"]:
                return (torch.randn_like(points_rand[:,:1]) - 0.1) *std_val
