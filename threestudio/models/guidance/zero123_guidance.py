...
def get_obj_from_str(string, reload=False):
    print(f'geting obj from str: {string}')
...
class Zero123Guidance(BaseObject):
    ...
    def configure(self) -> None:
        threestudio.info(f"Loading Zero123 from: {self.cfg.pretrained_model_name_or_path} ...")
